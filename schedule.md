...
Each week there are readings listed under *Core* and *Cenumbra*. The core readings are just that: central to the week's discussion and lab. You should read these closely and prepare to discuss them. The penumbral readings include some of the many brilliant pertinent readings I could not include because time is, sadly, finite. I encourage you to read them and feel free to bring insights from them to class, but I do not strictly require you to read them. In the week you lead class you should definitely prepare both the core and penumbral readings, and if you choose to dig into one of these topics for an assignment the penumbral readings are the first place you can start expanding your thinking.
...
+ Lisa Gitelman, "Near Print and Beyond Paper: Knowing by *.pdf" from *Paper Knowledge: Toward a Media History of Documents* (2014)
+ Jonathan Senchyne, "Paper Nationalism: Material Textuality and Communal Affiliation in Early America" (2017)

## Penumbra:

+ ——, "Preface" and "A Short History of __________" from *Paper Knowledge: Toward a Media History of Documents* (2014)
...
+ Benjamin Franklin, *The Autobiography of Benjamin Franklin*, Chapters 2-7 (find the Autobiography at the bottom of the left-hand column on [this page](http://franklinpapers.org/franklin/framedVolumes.jsp))
...
+ ["Printing" vocational film](https://youtu.be/bPCiWiLu-W4) (1947)
...
*Note: Professor Cordell away: remote class; no lab*
...
+ Whitney Anne Trettien, "Creative Destruction / 'Digital Humanities'"  https://medium.com/@whitneytrettien/creative-destruction-digital-humanities-607c080b635e#.u6tzdiwa6
...
+ (Watch) ["Elektrobiblioteka / Electrolibrary"](https://vimeo.com/47656204)
...
### Lab 10: Computational Text Analysis I
...
### Lab 11: Computational Text Analysis II

-----

# April 17: Pied

### Lab 12: Computational Text Analysis III
